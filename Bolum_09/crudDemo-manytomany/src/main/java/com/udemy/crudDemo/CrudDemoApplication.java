...
public class CrudDemoApplication {
    ...
    private void addMoreCoursesForStudent(AppDAO appDAO) {
        ...
        Course tempCourse = new Course("bir kurs ");
        Course tempCourse2 = new Course("bir kurs daha");
        Course tempCourse3 = new Course("al bir kurs daha");
    ...
    private void findStudentAndCourses(AppDAO appDAO) {
        System.out.println(appDAO.findStudentAndCoursesByStudentId(2));
    }

    private void findCourseAndStudents(AppDAO appDAO) {
        System.out.println(appDAO.findCourseAndStudentsByCourseId(10).getStudents());
    }

    private void createCourseAndStudents(AppDAO appDAO) {
        Course tempCourse = new Course("first course");
        Student tempStudent = new Student("first", "name", "email@email");
        Student tempStudent2 = new Student("first2", "name", "email@email");
        Student tempStudent3 = new Student("first3", "name", "email@email");
    ...
    private void retrieveCourseAndReviews(AppDAO appDAO) {
        System.out.println(appDAO.findCourseAndReviewsByCourseId(10).getReviews());
    }

    private void createCourseAndReviews(AppDAO appDAO) {
        Course tempCourse = new Course("new Course");
        tempCourse.addReview(new Review("first comment"));
        tempCourse.addReview(new Review("second comment"));
        tempCourse.addReview(new Review("third comment"));
